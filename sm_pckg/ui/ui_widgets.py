...
class UI():
    ...
    def init_ui_elements(self):
        ...
        self.width.setFixedSize(self.edit_size_int)
        self.width.setValidator(self.number_validator)
        self.width.setToolTip("Resolution width.")
        self.width.setAlignment(self.align_center)

        self.separator_02 = QLabel("x")
        self.separator_02.setAlignment(self.align_center)

        self.height = QLineEdit("height_input")
        self.height.setFixedSize(self.edit_size_int)
        self.height.setValidator(self.number_validator)
        self.height.setToolTip("Resolution height.")
        self.height.setAlignment(self.align_center)
        ...
        self.base_layout.addWidget(self.width)
        self.base_layout.addWidget(self.separator_02)
        self.base_layout.addWidget(self.height)
